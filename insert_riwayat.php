...
<body>
    ...
    <div class="container mt-4 mb-4">
        ...
        <form action="" id="fupForm" name="form1" method="post">
            ...
            <input class="form-control form-insert" type="text" id="telepon" name="telepon" value="<?php echo $arr['telepon']; ?>" hidden>
            <small class="text-muted">Diservis tanggal:</small>
            <input class="form-control form-insert mb-3" type="text" id="tanggalServis" name="tanggalServis" value="<?php echo $date; ?>" disabled>
            ...
            <input class="form-control form-insert" type="text" id="kilometer" name="kilometer" placeholder="Pembacaan KM">
            <!-- button -->
