...
$sql2 = "insert into mobil (noRangka, noPolisi, tglBeli) values ('$noRangka', '$noPolisi', '$tglBeli')";
$sql3 = "insert into detail_servis (tglServisTerakhir, tglServisSelanjutnya, noRangka) values ('$tglServisTerakhir', '$tglServisSelanjutnya', '$noRangka')";
